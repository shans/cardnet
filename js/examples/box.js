...
front.join(cardnet.tabShape('height', 'tabdepth', 'solid'), 1, 0);
front.join(cardnet.tabShape('height', 'tabdepth', 'solid'), 3, 0);

var back = base.join(cardnet.rect('width', 'height', 'solid'), 0, 0);
back.join(cardnet.tabShape('height', 'tabdepth', 'solid'), 1, 0);
back.join(cardnet.tabShape('height', 'tabdepth', 'solid'), 3, 0);

var lid = front.join(cardnet.rect('width', 'depth', 'solid', id='lid'), 2, 0);
lid.join(cardnet.tabShape('width', 'tabdepth', 'solid'), 2, 0);
lid.join(cardnet.tabShape('depth', 'tabdepth', 'solid'), 3, 0);
lid.join(cardnet.tabShape('depth', 'tabdepth', 'solid'), 1, 0);
